...
<template>
  <div class="group flex items-center gap-3 px-2.5 py-2 bg-slate-950/40 border border-white/10 rounded-xl hover:border-purple-500/40 transition-colors">
    ...
    <button v-if="coverable"
            ...
            class="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-full text-slate-600 hover:text-white hover:bg-purple-600 opacity-0 group-hover:opacity-100 transition-all"
            title="Use as collection cover" aria-label="Use as collection cover">
